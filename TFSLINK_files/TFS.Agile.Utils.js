...
//----------------------------------------------------------
define(["require","exports","Presentation/Scripts/TFS/TFS","Presentation/Scripts/TFS/TFS.Host","Presentation/Scripts/TFS/TFS.Diag","Presentation/Scripts/TFS/TFS.Core","Presentation/Scripts/TFS/TFS.OM","WorkItemTracking/Scripts/TFS.WorkItemTracking","WorkItemTracking/Scripts/TFS.WorkItemTracking.Controls"],function(l,b,h,g,a,d,f,c,e){(function(a){a.AssignedTo="System.AssignedTo";a.Id="System.Id";a.IterationPath="System.IterationPath";a.AreaPath="System.AreaPath";a.State="System.State";a.Title="System.Title";a.WorkItemType="System.WorkItemType"})(b.DatabaseCoreFieldRefName||(b.DatabaseCoreFieldRefName={}));var i=b.DatabaseCoreFieldRefName;(function(b){b.CHILD_LINK_NAME="System.LinkTypes.Hierarchy-Forward";b.PARENT_LINK_NAME="System.LinkTypes.Hierarchy-Reverse";function k(f){a.assertParamIsObject(f,"workItem");var d,h,g=f.getLinks(),c,e;for(d=0,h=g.length;d<h;d+=1){c=g[d];if($.isFunction(c.getLinkTypeEnd)&&c.getLinkTypeEnd().immutableName===b.PARENT_LINK_NAME){e=c;break}}return e}b.getWorkItemParentLink=k;function i(c,h,f,g,e,d){a.assertParamIsObject(c,"workItem");a.assertParamIsNotNull(f,"fieldId");a.assertParamIsNotUndefined(g,"value");a.assertParamIsFunction(e,"successCallback");a.assertParamIsFunction(d,"errorCallback");this.beginGetLinkedWorkItems(c,b.CHILD_LINK_NAME,true,function(a){var b,j,i;h&&a.push(c);for(b=0,j=a.length;b<j;b+=1){i=a[b].getField(f);i&&i.setValue(g)}c.store.beginSaveWorkItemsBatch(a,e,d)},d)}b.beginUpdateChildWorkItems=i;function j(e,i,j,c,f){a.assertParamIsObject(e,"workItem");a.assertParamIsFunction(c,"successCallback");var h=e.store,d=[],b=0;function g(n){var e,l,k=n.getLinks(),a,m=function(a){d.push(a);j&&g(a);b-=1;b===0&&c(d)};for(e=0,l=k.length;e<l;e+=1){a=k[e];if($.isFunction(a.getLinkTypeEnd)&&a.getLinkTypeEnd().immutableName===i){b+=1;h.beginGetWorkItem(a.getTargetId(),m,f)}}b===0&&c(d)}h.beginGetLinkTypes(function(){g(e)},f)}b.beginGetLinkedWorkItems=j;function l(j,i,e,k,h){a.assertParamIsObject(j,"store");a.assertParamIsStringNotEmpty(i,"workItemType");a.assertParamIsObject(e,"parenting");a.assertParamIsNumber(e.id,"parenting.id");a.assertParamIsFunction(k,"successCallback");a.assertParamIsFunction(h,"errorCallback");var m=j.workItemManager,f;function l(l){a.assertParamIsObject(l,"workItem");var m,n,j,g,h;if(!f){f=l;return}if(f.id===e.id){j=f;g=l}else{j=l;g=f}g.addLinks([c.WorkItemLink.create(g,b.PARENT_LINK_NAME,j.id,"")]);if(e.fields)for(m=0,n=e.fields.length;m<n;m+=1){h=g.getField(e.fields[m]);if(h){a.assertIsObject(j.getField(h.fieldDefinition.id),d.StringUtils.format("Configuration error: Parent work item {0} didn't have field {1}",i,h.fieldDefinition.referenceName));h.setValue(j.getFieldValue(h.fieldDefinition.id))}}k(g)}m.beginGetWorkItem(e.id,l,h);j.beginGetProject(g.TfsContext.getDefault().navigation.project,function(b){a.assertParamIsObject(b,"project");b.beginGetWorkItemType(i,function(a){l(m.createWorkItem(a))},h)},h)}b.beginCreateWorkItem=l;function h(d,i,g,h,j,k){a.assertParamIsString(d,"workItemTypeName");a.assertParamIsObject(i,"parentOptions");a.assertParamIsFunction(g,"successCallback");a.assertParamIsFunction(h,"errorCallback");var l=f.TfsTeamProjectCollection.getDefaultConnection().getService(c.WorkItemStore);b.beginCreateWorkItem(l,d,i,function(a){$.isFunction(j)&&j(a);e.WorkItemForm.showWorkItem(a,{save:g,close:k})},h)}b.beginCreateWorkItemWithForm=h;function m(c,b){a.assertParamIsObject(c,"workItem");a.assertParamIsString(b,"fieldName");var e,d=c.getField(b);if(d)e=d.getValue();return e}b.getFieldValueByName=m;function n(d,e){a.assertParamIsObject(d,"workItem");a.assertParamIsNumber(e,"parentId");var f=false,g=b.getWorkItemParentLink(d);if(g){if(g.linkData.ID===e)return false;d.removeLinks([g]);f=true}if(e>0){d.addLinks([c.WorkItemLink.create(d,b.PARENT_LINK_NAME,e,"")]);f=true}return f}b.reparentWorkItem=n})(b.WorkItemUtils||(b.WorkItemUtils={}));var j=b.WorkItemUtils;(function(b){function c(b){a.assertParamIsObject(b,"$inputField");b.keypress(function(a){return a.keyCode>=48&&a.keyCode<=57?true:false});b.bind("paste",function(){var a=this.value;d.delay(this,0,function(){if(!/^[0-9]+$/m.test(this.value))this.value=a})})}b.restrictTextInputToIntegers=c;function e(f,b){a.assertParamIsObject(f,"$container");a.assertParamIsObject(b,"options");a.assert(Boolean(b.label)&&Boolean(b.id)||!Boolean(b.label),"if label is supplied an id need to be supplied");var e=$("<div/>").addClass("combo"),d=$("<div/>").addClass("wrap"),c=$("<input />").attr("type","text").css("width","100%");b.id&&c.attr("id",b.id);b.disabled&&c.attr("disabled",b.disabled);b.className&&c.addClass(b.className);d.append(c);b.label&&d.append($("<label/>").text(b.label).addClass("hidden").attr("For",b.id));e.append(d);f.append(e);return c}b.createTextbox=e})(b.ControlUtils||(b.ControlUtils={}));var k=b.ControlUtils;h.tfsModuleLoaded("TFS.Agile.Utils",b)});
// SIG // Begin signature block
// SIG // MIIaqQYJKoZIhvcNAQcCoIIamjCCGpYCAQExCzAJBgUr
// SIG // DgMCGgUAMGcGCisGAQQBgjcCAQSgWTBXMDIGCisGAQQB
// SIG // gjcCAR4wJAIBAQQQEODJBs441BGiowAQS9NQkAIBAAIB
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAE